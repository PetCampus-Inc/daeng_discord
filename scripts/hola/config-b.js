// Post B — PM / 디자이너 / 기획자 모집 글. 짝수일 (2,4,6,...) 자동 게시.
// HOLA_CONFIG=config-b.js node scripts/hola/post.js

module.exports = {
  // 옵션: 프로젝트 | 스터디
  type: "프로젝트",

  // 옵션: 인원 미정 | 1명 | 2명 | … | 10명 이상
  recruitCount: "2명",

  // 옵션: 온라인 | 오프라인 | 온/오프라인
  mode: "온/오프라인",

  // 옵션: 기간 미정 | 1개월 | 2개월 | 3개월 | 4개월 | 5개월 | 6개월 | 장기
  period: "6개월",

  // 시작 예정 (YYYY-MM-DD). 비워두면 post.js 가 오늘 날짜로 자동 채움.
  startDate: "",
  ...
  // 제목
  title:
    "🐶 [🚨급) PM, 디자이너 모십니다🙇🏻‍♂️] [실제 유저 사용 중 !!] 8년 차 빅테크 개발자와 함께 하는 '반려련 플랫폼 사이드 프로젝트' 충원",

  // 본문 — Obsidian /Users/USER/Documents/Obsidian Vault/내용2.md 기반, 마크다운 정리
  body: `🐶 반려견 플랫폼 사이드프로젝트 팀원 모집

⚠️ 기획 팀은 총 4명 구성 예정이며 현재 2명 픽스된 상황입니다.
